 ...
 */
public class FingerprintResponseNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public FingerprintResponseNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
